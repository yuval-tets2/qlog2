...
@InputType()
class CatalogCreateNestedManyWithoutProductTypesInput {
...
export { CatalogCreateNestedManyWithoutProductTypesInput as CatalogCreateNestedManyWithoutProductTypesInput };
